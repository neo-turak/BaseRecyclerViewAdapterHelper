 ...
 * @constructor
 */
abstract class BaseProviderMultiAdapter<T>(mItems: MutableList<T>? = null) :
        BaseQuickAdapter<T, BaseViewHolder>(0, mItems) {
     ...
     * @return Int
     */
    protected abstract fun getItemType(items: MutableList<T>, position: Int): Int
    ...
    override fun convert(holder: BaseViewHolder, item: T, payloads: MutableList<Any>) {
    ...
    protected open fun bindClick(viewHolder: BaseViewHolder) {
        if (getOnItemClickListener() == null) {
            ...
            viewHolder.itemView.setOnClickListener {
                ...
                provider.onClick(viewHolder, it, items[position], position)
            }
        }
        if (getOnItemLongClickListener() == null) {
            ...
            viewHolder.itemView.setOnLongClickListener {
                ...
                val itemViewType = viewHolder.itemViewType
                val provider = mItemProviders.get(itemViewType)
                provider.onLongClick(viewHolder, it, items[position], position)
            }
        }
    }
            ...
            ids.forEach { id ->
                viewHolder.itemView.findViewById<View>(id)?.let {
                    ...
                    it.setOnClickListener { v ->
                        ...
                        position -= headerLayoutCount
                        provider.onChildClick(viewHolder, v, items[position], position)
                    }
                }
            }
        }
            ...
            ids.forEach { id ->
                viewHolder.itemView.findViewById<View>(id)?.let {
                    ...
                    it.setOnLongClickListener { v ->
                        ...
                        position -= headerLayoutCount
                        provider.onChildLongClick(viewHolder, v, items[position], position)
                    }
                }
            }
        }
