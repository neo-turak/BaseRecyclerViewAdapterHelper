...
open class BaseBinderAdapter(list: MutableList<Any>? = null) : BaseQuickAdapter<Any, BaseViewHolder>(0, list) {
    ...
    override fun convert(holder: BaseViewHolder, item: Any, payloads: MutableList<Any>) {
    ...
    override fun getDefItemViewType(position: Int): Int {
        return findViewType(items[position].javaClass)
    }
    ...
    protected open fun bindClick(viewHolder: BaseViewHolder) {
        if (getOnItemClickListener() == null) {
            ...
            viewHolder.itemView.setOnClickListener {
                ...
                binder.onClick(viewHolder, it, items[position], position)
            }
        }
