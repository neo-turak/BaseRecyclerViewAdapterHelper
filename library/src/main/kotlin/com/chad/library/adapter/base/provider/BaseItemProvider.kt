...
abstract class BaseItemProvider<T> {
    ...
    private val clickViewIds by lazy(LazyThreadSafetyMode.NONE) { mutableListOf<Int>() }
    private val longClickViewIds by lazy(LazyThreadSafetyMode.NONE) { mutableListOf<Int>() }
    ...
    open fun convert(helper: BaseViewHolder, item: T, payloads: MutableList<Any>) {}
     ...
     * @param position Int
     */
    open fun onClick(helper: BaseViewHolder, view: View, item: T, position: Int) {}
     ...
     * @return Boolean
     */
    open fun onLongClick(helper: BaseViewHolder, view: View, item: T, position: Int): Boolean {
        return false
    }

    open fun onChildClick(helper: BaseViewHolder, view: View, item: T, position: Int) {}

    open fun onChildLongClick(helper: BaseViewHolder, view: View, item: T, position: Int): Boolean {
        return false
    }
